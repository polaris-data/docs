...
<ParamField query="asset" type="string" required>
  Exact Polaris asset ID for the market.
</ParamField>
...
- Read [Snapshot metadata](/schemas/snapshot-metadata) if you want the list and download response shapes in one place.
