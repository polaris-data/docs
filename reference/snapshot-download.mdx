...
The downloaded `.jsonl.zst` file contains standardized event records. See [Standardised formats](/reference/standardised-formats) for the event envelope inside the file.
