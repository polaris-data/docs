...
Returns flattened market coverage rows with per-market UTC bounds, dataset categories, and access metadata.
...
<ResponseField name="markets.source_type" type="string" required>
