...
Trade events use the standard event envelope (see [Standardised formats](/reference/standardised-formats)) with `type: "trade"` and the following trade-specific fields under `data`:
...
- [Standardised formats](/reference/standardised-formats) for the full event envelope trades are nested in
