...
L2 snapshots use the standard event envelope (see [Standardised formats](/reference/standardised-formats)) with `type: "orderbook"` and the following order book-specific fields under `data`:
...
- [Standardised formats](/reference/standardised-formats) for the full event envelope order book snapshots are nested in
