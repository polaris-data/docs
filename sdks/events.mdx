...
Events use the standard event envelope described in [Standardised formats](/reference/standardised-formats), with each event's typed payload under `data`.
...
- [Standardised formats](/reference/standardised-formats) for the event envelope behind each record
