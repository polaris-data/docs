...
- [Standardised formats](/reference/standardised-formats) for the event envelope volatility is derived from
- [OHLCV](/sdks/ohlcv) if you need price data for volatility calculations
